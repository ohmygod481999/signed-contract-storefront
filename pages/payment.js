    ...
    return isEmpty(order) ? (
        ...
        <div className="order-summary-section">
            <div className="order-summary-header">
                <h1>ORDER SUMMARY</h1>
                <p className="order-summary__order-id">Order ID: <span>#00032</span></p>
            </div>
                ...
                <div className="row">
                    <div className="col-md-8">
                        ...
                        <div className="order-summary-cart">
                            <div className="order-summary-cart__item">
                                <div>
                                    <h5>VOLCANIC CLAY – NEW VERSION</h5>
                                    <p>Quantity: 2</p>
                                </div>
                            ...
                            <div className="order-summary-cart__item">
                                <div>
                                    <h5>KEVIN MURPHY ROUGH RIDER</h5>
                                    <p>Quantity: 1</p>
                                </div>
                                <div className="order-summary-cart__item-price">
                                    2,000,000đ
                    ...
                    <div className="col-md-4">
                        ...
                        <div className="order-summary-cart__address">
                            <p>Vương Bảo Long</p>
                            <p>Số 17, 622 Minh Khai Hà Nội</p>
                            <p>Phone: 0829400301</p>
                        </div>
                        ...
                        <div className="order-summary-cart__cost">
                            ...
                            <div className="order-summary-cart__cost-total">
                                ...
                                <div><strong>30,000đ</strong></div>
                            </div>
                        </div>
                    </div>
                    <div className="col-md-12 order-summary__thanks-order">
                        <p className="text-center">Thanks for your order. Go back to <Link href="/">home</Link></p>
                    </div>
                </div>
            </div>
        </div>
