/*! UIkit 3.0.0-beta.2 | https://www.getuikit.com | (c) 2014 - 2016 YOOtheme | MIT License */
...
UIkit.mixin({
    ...
    events: {
        ...
        showitem: function showitem(e) {
            ...
            $.ajax({type: 'GET', url: ("https://vimeo.com/api/oembed.json?url=" + (encodeURI(item.source))), jsonp: 'callback', dataType: 'jsonp'}).then(function (res) { return setIframe(res.width, res.height); });
